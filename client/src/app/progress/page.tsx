...
function eventLabel(eventType: string): string {
  ...
  if (normalized === "VOTE" || normalized === "QUALIFIED_VOTE") return "기사 첫 평가";
  return "기타 활동";
}
...
export default function ProgressPage() {
  ...
  return (
    <div className="progress-page" data-highlight-tone={ideologyHighlightTone(snapshot.ideology)}>
      ...
      <div className="section-head"><h2>뉴스 소비와 검사 결과</h2><Badge>기사 평가와 이념을 분리</Badge></div>
      <PerspectivePreview displayName="" snapshot={consumptionSnapshot(snapshot)} compact />
