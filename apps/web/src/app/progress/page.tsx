...
export default function ProgressPage() {
  return <><PageHeader eyebrow="My activity / policy-v4" title="읽고 비교한 기록" description="활동 크레딧은 검증된 비교·복귀 활동의 기록이며 정치적 정답이나 우열을 뜻하지 않습니다." actions={<Link className="button button--secondary" href="/efficacy">효능감 추이 <ArrowUpRight size={16} /></Link>} />
